...
const CONFIG = {
    ...
    featuredPhotos: [
        { path: 'photo1.jpg', caption: '我們在一起了 ❤️' },
        { path: 'photo2.jpg', caption: '第一次吵架又和好 🩹' },
        { path: 'photo3.jpg', caption: '第一次實體見面 🏪' },
        { path: 'photo4.jpg', caption: '第一次約會 🍽️' },
        { path: 'photo5.jpg', caption: '第一次看棒球 ⚾' },
        { path: 'photo6.jpg', caption: '第一次探索台北 🗺️' },
        { path: 'photo7.jpg', caption: '一起過生日 🎂' },
        { path: 'photo8.jpg', caption: '最幸福的一天 🥰' },
        { path: 'photo9.jpg', caption: '我們的日常 📱' },
        { path: 'photo10.jpg', caption: '一周年快樂 💖' }
    ],
    galleryPhotos: [
        { path: 'gallery01.jpg', caption: '回憶照片 01 ❤️' },
        { path: 'gallery02.jpg', caption: '回憶照片 02 ❤️' },
        { path: 'gallery03.jpg', caption: '回憶照片 03 ❤️' },
        { path: 'gallery04.jpg', caption: '回憶照片 04 ❤️' },
        { path: 'gallery05.jpg', caption: '回憶照片 05 ❤️' },
        { path: 'gallery06.jpg', caption: '回憶照片 06 ❤️' },
        { path: 'gallery07.jpg', caption: '回憶照片 07 ❤️' },
        { path: 'gallery08.jpg', caption: '回憶照片 08 ❤️' },
        { path: 'gallery09.jpg', caption: '回憶照片 09 ❤️' },
        { path: 'gallery10.jpg', caption: '回憶照片 10 ❤️' },
        { path: 'gallery11.jpg', caption: '回憶照片 11 ❤️' },
        { path: 'gallery12.jpg', caption: '回憶照片 12 ❤️' },
        { path: 'gallery13.jpg', caption: '回憶照片 13 ❤️' },
        { path: 'gallery14.jpg', caption: '回憶照片 14 ❤️' },
        { path: 'gallery15.jpg', caption: '回憶照片 15 ❤️' },
        { path: 'gallery16.jpg', caption: '回憶照片 16 ❤️' }
    ]
};
